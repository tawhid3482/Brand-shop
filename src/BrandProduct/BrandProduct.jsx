...
const BrandProduct = ({ brandName }) => {
  const [products, loading, error] = FetchHook();
    ...
    <div>
      ...
      <div className="carousel w-full h-96">
        <div id="item1" className="carousel-item w-full">
          <img src={silder1} className="w-full" alt="Electrical Appliances" />
        </div>
        <div id="item2" className="carousel-item w-full">
          <img src={silder2} className="w-full" alt="Black Friday Sale" />
        </div>
        <div id="item3" className="carousel-item w-full">
          <img src={silder3} className="w-full" alt="Sale Banner" />
        </div>
      </div>
